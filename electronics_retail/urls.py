...
from electronics_retail.apps import RetailConfig
from electronics_retail.views import DealerCreateListAPIView, DealerDetailUpdateDeleteAPIView, ProductsCreateListAPIView, \
