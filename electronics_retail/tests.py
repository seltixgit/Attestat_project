...
from electronics_retail.models import Products, Dealer
...
class ProductTestCase(APITestCase):
    ...
    def test_create_product(self):
        ...
        response = self.client.post('/api/electronics_retail/products/', data=data)
        self.assertEquals(
    ...
    def test_list_products(self):
        ...
        self.client.force_authenticate(user=self.user)
        response = self.client.get('/api/electronics_retail/products/')
        self.assertEquals(
            response.status_code,
            status.HTTP_200_OK
        )
    ...
    def test_update_products(self):
        ...
        response = self.client.patch(f'/api/electronics_retail/products/{self.product.id}/', data=data)
        self.assertEquals(
            response.status_code,
            status.HTTP_200_OK
        )
    ...
    def test_no_owner_product(self):
        ...
        response2 = self.client.delete(f'/api/electronics_retail/products/{self.product.id}/')
        self.assertEquals(
    ...
    def test_delete_product(self):
        ...
        self.client.force_authenticate(user=self.user)
        response = self.client.delete(f'/api/electronics_retail/products/{self.product.id}/')
        self.assertEquals(
            response.status_code,
...
class DealerTestCase(APITestCase):
    ...
    def test_create_dealer(self):
        ...
        response = self.client.post('/api/electronics_retail/', data=data)
        self.assertEquals(
            response.status_code,
            status.HTTP_201_CREATED
        )
    ...
    def test_list_dealers(self):
        ...
        self.client.force_authenticate(user=self.user)
        response = self.client.get('/api/electronics_retail/')
        self.assertEquals(
            response.status_code,
            status.HTTP_200_OK
        )
    ...
    def test_update_dealer(self):
        ...
        response = self.client.patch(f'/api/electronics_retail/{self.dealer2.id}/', data=data)
        self.assertEquals(
            response.status_code,
            status.HTTP_200_OK
        )
        ...
        response2 = self.client.get(f'/api/electronics_retail/{self.dealer2.id}/')
        self.assertEquals(
            response2.json(),
            {'title': 'Test_Dealer_2', 'dealer_type': 'RETAIL', 'email': 'test_dealer_2@test.ru', 'country': None,
    ...
    def test_no_owner(self):
        ...
        response = self.client.patch(f'/api/electronics_retail/{self.dealer.id}/', data=data)
        self.assertEquals(
            response.status_code,
            status.HTTP_403_FORBIDDEN
        )
        response2 = self.client.delete(f'/api/electronics_retail/{self.dealer.id}/')
        self.assertEquals(
            response2.status_code,
            status.HTTP_403_FORBIDDEN
        )
    ...
    def test_delete_dealer(self):
        ...
        self.client.force_authenticate(user=self.user)
        response = self.client.delete(f'/api/electronics_retail/{self.dealer2.id}/')
        self.assertEquals(
            response.status_code,
            status.HTTP_204_NO_CONTENT
        )
